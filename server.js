...
var connector = new builder.ChatConnector({
    appId: process.env.MICROSOFT_APP_ID || 'c7cd2dd1-b0d0-4e3d-8998-245f4fb2606c' ,
    appPassword: process.env.MICROSOFT_APP_PASSWORD || 'b4ucezmTbqhgfmEkEHzg1Zp'
});
var bot = new builder.UniversalBot(connector);
// If a Post request is made to /api/messages on port 3978 of our local server, then we pass it to the bot connector to handle
server.post('/api/messages', connector.listen());

var luisRecognizer = new builder.LuisRecognizer('https://westus.api.cognitive.microsoft.com/luis/v2.0/apps/b1ff8fa5-3b94-4420-a473-73abe94ca9f7?subscription-key=ed6a31ca35044f84a68f77fb07291f99');
...
bot.dialog('/sayHi', function(session) {
    session.send('Hi there!  Try saying things like "Get me the news"');
    session.endDialog();
});
